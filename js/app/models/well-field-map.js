define(['jquery', 'knockout', 'app/datacontext', 'bootstrap-modal', 'app/app-helper', 'app/models/well-field-map-area', 'app/models/well-in-well-field-map'],
        ...
        function WellFieldMap(data, wellField) {
            ...
            function initYandexMap(wellFieldMapItem, wellFieldItem) {
                ...
                var WellMapLayer = function () {
                    ...
                    //var mapUrl = 'http://wfm-client.azurewebsites.net/api/wellfile/?well_id=80&purpose=history&status=work&file_name=fid20130212221840151_MOTsketch.jpeg&crop(%z,%z,%x,%y)'
