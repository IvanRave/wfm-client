...
define(['knockout',
    ...
    function (ko,
        ...
        function importEmployees(data, userProfileItem) {
            return data.map(function (item) { return new Employee(item, userProfileItem); });
        }
        ...
        var userProfilePropSpecList = [
            ...
            * @type {string}
            */
            new PropSpec('email', 'Email', 'Email', 'SingleLine', { maxLength: 320 })
        ];
        ...
        var exports = function (data, rootMdl) {
            ...
            */
            this.loadEmployees = function () {
                if (ko.unwrap(ths.isLoadedEmployees)) { return; }
