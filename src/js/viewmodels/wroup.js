...
define(['knockout',
    ...
    function (ko,
        ...
        * @constructor
        */
        var exports = function (mdlWroup, koUnqOfSlcVwmWroup, defaultSlcData, fmgrLink) {
            var ths = this;
            ...
            */
            this.listOfVwmChild = ko.computed({
                read: function () {
                    return ko.unwrap(mdlWroup.wells).map(function (elem) {
                        return new VwmWell(elem, ths.unqOfSlcVwmChild, defaultSlcData, ths.fmgr);
                    });
                },
            ...
            VwmStageBase.call(this, defaultSlcData.wroupSectionId, koUnqOfSlcVwmWroup);
        };
